...
#Round1
python3 src/c006__generate_paired_data_from_fixer.py --round_name round0 --out_round_name round1-FixerOnly
python3 src/c001__train_fixer.py --round_name round1-FixerOnly --max_epoch 1 --continue_from '/mnt/disks/persist/data/round0/model-fixer/checkpoint.pt'
